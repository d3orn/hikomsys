	...
	<body>
		<div id="wrapper">
			...
			<?php
				...
				$collectionName = $_SESSION['projectname'];
			...
			<script type="text/javascript" src="/hikomsys/min/?b=hikomsys/scripts/javascripts&amp;f=jstree/jquery.jstree.js,jstree/_lib/jquery.cookie.js,packageViewer.js"></script> 
