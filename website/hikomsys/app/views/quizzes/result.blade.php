...
@section('content')
	...
	<div id="menu">
		...
		<div id="greenArrow" aria-hidden="true" data-icon="&#xe600;" class="arrowbtn icon-arrow-right activatedIcon buttonlike"></div>
		<div id="orangeArrow" aria-hidden="true" data-icon="&#xe600;" class="arrowbtn icon-arrow-right activatedIcon buttonlike"></div>
		<div id="redArrow" aria-hidden="true" data-icon="&#xe600;" class="arrowbtn icon-arrow-right activatedIcon buttonlike"></div>
